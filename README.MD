...
Ensure you install python3.12 and [uv](https://docs.astral.sh/uv/#installation), then type:

```
uv tool install -p python3.12 https://github.com/fdev31/kokorodoki/archive/refs/heads/master.zip
```
