...
🎧 [Voice Demo - af_heart](https://github.com/user-attachments/assets/b1f5b1bc-e141-47b4-908e-abc5fdf5f70a)
...
```bash
sudo dnf install -y python3.12 python3.12-devel python3-virtualenv portaudio espeak xclip
```
